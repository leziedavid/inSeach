                        ...
                        return (
                            <div
                                ...
                                className={`
                                    ...
                                    ${date ? `bg-white hover:bg-gray-50 cursor-pointer border border-transparent ${isCurrentDay ? "ring-2 ring-blue-500 ring-opacity-50" : ""} ${hasAppointments ? "bg-[#b07b5e]/10 hover:bg-[#b07b5e]/20 border-[#b07b5e]/30" : ""}` : "bg-transparent"
                                    } `}
