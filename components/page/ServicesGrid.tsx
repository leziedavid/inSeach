...
export default function ServicesGrid({ services }: ServicesGridProps) {
    ...
    return (
        <div className="w-full max-w-md mx-auto p-4 flex flex-col gap-6">
            ...
            <div className="relative w-full mb-8" ref={suggestionsRef}>
                <div className="flex space-x-2 items-center">
                    ...
                    <div className="relative flex-1">
                        <input
                            ...
                            className="w-full p-2 text-sm border border-r-0 border-gray-100 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#155e7533] pl-9 focus:border-gray-100"
                            style={{ fontSize: "16px" }}
                        />
                        ...
                        {search && (
                            <button
                                ...
                                className="absolute right-2 top-1/2 -translate-y-1/2 p-0.5 hover:bg-gray-100 rounded-full transition"
                            >
                ...
                {/* Suggestions de noms de services */}
                ...
                {isLoading ? (
                    ...
                    <>
                        <div className="grid grid-cols-3 gap-2 mb-3">
                            {service.map((service) => (
                                <div key={service.id} onClick={() => handleSelectService(service)} className={`bg-white rounded-lg p-2 border border-[#b07b5e]/80 shadow-xs hover:shadow-sm transition-all cursor-pointer flex flex-col items-center text-center ${selectedService?.id === service.id ? "ring-2 ring-[#a06a50]" : ""}`} >
                        ...
                        {/* Information sur le nombre de services */}
